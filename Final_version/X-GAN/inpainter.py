...
if __name__ == '__main__':
    tf.app.run()
    '''
    python inpainter.py --dataset test_cat_O --dataset2 test_cat_G --is_crop False --nIter 1000 --imgs /media/rex/Extra/DeepWorking/xcsGAN/data/test_cat_G/ --outDir /media/rex/Extra/DeepWorking/ccGAN/XGAN/Inpating --maskType center
    '''
