...
def save_images_inpaint(images, size, image_path):
    return imsave_inpaint(inverse_transform(images), size, image_path)
...
def imsave_inpaint(images, size, path):
    image = np.squeeze(merge_inpaint(images, size))
