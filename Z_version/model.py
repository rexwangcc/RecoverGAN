...
modified and tested input z for generator under specific circumstances (is_crop is on)
'''
...
class DCGAN(object):
    ...
    def __init__(self, sess, input_height=108, input_width=108, is_crop=True, batch_size=64, sample_num=64, output_height=64, output_width=64, y_dim=None, z_dim=300, gf_dim=64, df_dim=64, gfc_dim=1024, dfc_dim=1024, c_dim=3, dataset_name='default', dataset_name2='default',input_fname_pattern='*.jpg', checkpoint_dir=None, sample_dir=None):
    ...
    def train(self, config):
        ...
        if config.dataset == 'mnist':
            ...
            data2 = glob(os.path.join("./data", config.dataset2, self.input_fname_pattern))
                ...
                if np.mod(counter, 100) == 1:
                    if config.dataset == 'mnist':
                        ...
                        try:
                            ...
                            save_images(sample_blurred, [manifold_h, manifold_w],'./{}/blurred_{:02d}_{:04d}.png'.format(config.sample_dir, epoch, idx))
