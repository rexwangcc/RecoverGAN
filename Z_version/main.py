...
# added another place for blurred/secondary data
flags.DEFINE_string(flag_name="dataset2", default_value="celebA", docstring="The name of dataset [celebA, mnist, lsun]")
